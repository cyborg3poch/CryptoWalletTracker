      ...
      <div class="container-fluid py-4">
          ...
          <div class="row mb-4 mt-2">
              ...
              <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="${pageContext.request.contextPath}/addWallet" ><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Track Wallet</a>
            ...
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3">Tracked Wallet Address</h6>
                </div>
              </div>
